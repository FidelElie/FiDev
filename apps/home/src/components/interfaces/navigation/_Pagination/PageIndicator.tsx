...
export const PageIndicator = (props: PageIndicatorProps) => {
	...
	return (
		<div ref={containerRef} class="relative border border-slate-200 text-blue-500 rounded-lg">
			...
			>
				{
					new Array(props.pagination.pages || 1).fill(null).map((_, page) => (
						<option value={page + 1} selected={String(page + 1) === String(props.currentPage)}>
							{page + 1}
						</option>
					))
				}
